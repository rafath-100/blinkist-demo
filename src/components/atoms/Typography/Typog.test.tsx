...
describe("Display text", () => {
  test("Should be heading", () => {
    render(<Typog children="This is heading 1" variant="h1" />);
    const headingElement = screen.getByText(/This is heading 1/i);
    expect(headingElement).toBeInTheDocument();
  });

  test("Should be body", () => {
    render(<Typog children="This is body" variant="body1" />);
    const bodyElement = screen.getByText(/This is body/i);
    expect(bodyElement).toBeInTheDocument();
  });

  test("Should be subtitle", () => {
    render(<Typog children="This is subtitle" variant="subtitle1" />);
    const subtitleElement = screen.getByText(/This is subtitle/i);
    expect(subtitleElement).toBeInTheDocument();
  });

  test("Should be caption", () => {
    render(<Typog children="This is caption" variant="caption" />);
